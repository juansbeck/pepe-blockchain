...
var _ = Describe("Convert receiving IBC to Erc20", Ordered, func() {
	...
	Describe("enabled params and registered uosmo", func() {
		...
		It("should transfer and not convert usdtpe", func() {
			// Register 'usdtpe' coin in ERC-20 keeper to validate it is not converting the coins when receiving 'usdtpe' thru IBC
			...
			// 1. Send usdtpe from Evmos to Osmosis
			...
			// check ibc usdtpe coins balance on Osmosis
			...
			// 2. Send usdtpe IBC coins from Osmosis to Evmos
			...
			// check ibc usdtpe coins balance on Osmosis - should be zero
			...
			// check usdtpe balance after transfer - should be equal to initial balance
	...
	Describe("Performing claims with registered coin", func() {
		...
		It("it should perform the claim and convert the received tokens", func() {
			...
			// should trigger claims logic and send usdtpe coins from claims to receiver
