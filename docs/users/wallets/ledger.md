...
```
usdtped keys add NAME --ledger
```

**Example:**

```
usdtped keys add myledger --ledger
...
```
usdtped tx bank send myledger evmos1hnmrdr0jc2ve3ycxft0gcjjtrdkncpmmkeamf9 100000pose --fees 2000pose --from myledger
```
